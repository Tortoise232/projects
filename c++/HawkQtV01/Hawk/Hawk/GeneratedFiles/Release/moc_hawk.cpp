...
QT_MOC_LITERAL(3, 24, 16), // "addSubjectSignal"
QT_MOC_LITERAL(4, 41, 11), // "std::string"
QT_MOC_LITERAL(5, 53, 4), // "name"
QT_MOC_LITERAL(6, 58, 10), // "addSubject"
QT_MOC_LITERAL(7, 69, 16), // "addButtonHandler"
QT_MOC_LITERAL(8, 86, 26), // "increaseHoursButtonHandler"
QT_MOC_LITERAL(9, 113, 19), // "popOutButtonHandler"
QT_MOC_LITERAL(10, 133, 12) // "populateList"

    },
    "Hawk\0subjectListChange\0\0addSubjectSignal\0"
    "std::string\0name\0addSubject\0"
    "addButtonHandler\0increaseHoursButtonHandler\0"
    "popOutButtonHandler\0populateList"
};
...
void Hawk::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->addSubjectSignal((*reinterpret_cast< std::string(*)>(_a[1]))); break;
        case 2: _t->addSubject((*reinterpret_cast< std::string(*)>(_a[1]))); break;
        case 3: _t->addButtonHandler(); break;
        case 4: _t->increaseHoursButtonHandler(); break;
        case 5: _t->popOutButtonHandler(); break;
        case 6: _t->populateList(); break;
        default: ;
        }
        ...
        {
            typedef void (Hawk::*_t)(std::string );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Hawk::addSubjectSignal)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 1
void Hawk::addSubjectSignal(std::string _t1)
{
